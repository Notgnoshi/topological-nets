...
\begin{proof}
    ...
    \ \vspace{-0.5cm}\newline
    \begin{itemize}
        \item[$\lbrack\Rightarrow\rbrack$]\todo{To prove $\Rightarrow$, take as index set $J$ the collection of all neighborhoods of $x$, ordered by reverse inclusion.} Let $A \subset X$ and suppose $x \in \overline A$. We wish to show that there is a net in $A$ that converges to $x$.7
